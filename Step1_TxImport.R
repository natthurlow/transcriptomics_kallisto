...
library(datapasta) # allows pasting of data into R
...
Txi_gene <- tximport(path, 
                     type = "kallisto", 
                     tx2gene = Tx, 
                     txOut = FALSE, #Do you want gene or transcript level data out? How does the result change if this =FALSE vs =TRUE?
                     countsFromAbundance = "lengthScaledTPM",
                     ignoreTxVersion = TRUE) # the ".1 .2" at the end of the abundance files
beep(sound = 6)
